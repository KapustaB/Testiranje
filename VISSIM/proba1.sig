...
<sc version="201602" id="1" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="102567238">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="V1" defaultSignalSequence="3">
      <defaultDurations>
    ...
    <sg id="2" name="V2" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="2000" />
        <defaultDuration display="3" duration="5000" />
    ...
    <sg id="3" name="V3" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="2000" />
        <defaultDuration display="3" duration="5000" />
    ...
    <sg id="4" name="V4" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="2000" />
        <defaultDuration display="3" duration="5000" />
  ...
  <intergreenmatrices />
  <progs>
    <prog id="1" cycletime="60000" switchpoint="25000" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Signal program 1">
      <sgs>
